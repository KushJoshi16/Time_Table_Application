import generator_algo.data as dt
import generator_algo.cost_functions as cost_functions
import generator_algo.mutation as mutation
from copy import deepcopy

max_generations = 5000
num_runs = 1
input_file = 'classes/input.json'
output_file = 'classes/output.json'
...
def evolutionary_algorithm():
    ...
    for single_class in chromosome[0]:
        if single_class['Assigned_class'] not in single_class['Classroom']:
